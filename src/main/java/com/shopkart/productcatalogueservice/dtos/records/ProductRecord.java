...
public record ProductRecord(
        ...
        Long id,
        @NotBlank(groups = {OnCreate.class,OnReplace.class},message = "Name must be required to create a Product")
        String name,
        @NotNull(groups = {OnCreate.class,OnReplace.class},message = "Price must be required to create a Product")
        ...
        Double price,
        @NotBlank(groups = {OnCreate.class,OnReplace.class},message = "Category name must be required to create a Product")
        String description,
        @NotBlank(groups = {OnCreate.class,OnReplace.class},message = "Category name must be required to create a Product")
        String categoryName,
        @NotBlank(groups = {OnCreate.class,OnReplace.class},message = "Image URL must be provided to create a Product")
        String imageUrl){
